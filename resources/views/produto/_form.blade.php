...
<div class="form-grid form-grid--col-4" style="margin-top:1rem;">
    ...
    <div class="form-group">
        ...
        @include('components.input-numeric', [
            ...
            'value' => old(
                'preco_custo',
                isset($produto) ? number_format($produto->preco_custo ?? 0, 2, ',', '.') : '0,00'),
    ...
    <div class="form-group">
        ...
        @include('components.input-numeric', [
            ...
            'value' => old(
                'preco_venda',
                isset($produto) ? number_format($produto->preco_venda ?? 0, 2, ',', '.') : '0,00'),
    ...
    <div class="form-group">
        ...
        @include('components.input-numeric', [
            ...
            'value' => old(
                'preco_minimo',
                isset($produto) ? number_format($produto->preco_minimo ?? 0, 2, ',', '.') : '0,00'),
...
<div class="form-grid form-grid--col-4" style="margin-top:1rem;">
    <div class="form-group">
        ...
        @include('components.input-quantity', [
            ...
            'value' => old(
                'estoque_minimo',
                isset($produto) ? number_format($produto->estoque_minimo ?? 0, 2, ',', '.') : '0,00'),
    ...
    <div class="form-group">
        ...
        @include('components.input-quantity', [
            ...
            'value' => old(
                'estoque_maximo',
                isset($produto) && $produto->estoque_maximo !== null
                    ? number_format($produto->estoque_maximo ?? 0, 2, ',', '.')
                    : ''),
    ...
    <div class="form-group">
        ...
        @include('components.input-quantity', [
            ...
            'value' => old(
                'estoque_atual',
                isset($produto) ? number_format($produto->estoque_atual ?? 0, 2, ',', '.') : '0,00'),
    ...
    <div class="form-group">
        ...
        <select name="controla_estoque" class="form-control">
            <option value="1"
                {{ old('controla_estoque', $produto->controla_estoque ?? 1) == 1 ? 'selected' : '' }}>Sim
            </option>
            <option value="0"
                {{ old('controla_estoque', $produto->controla_estoque ?? '') == 0 ? 'selected' : '' }}>Não
            </option>
        </select>
    </div>
</div>
