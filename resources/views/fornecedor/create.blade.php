...
@section('breadcrumb')
    <a href="{{ route('fornecedor.index') }}">Fornecedores</a> / Novo Fornecedor
@endsection
                ...
                <div class="form-grid form-grid--col-4" style="margin-top:1rem;">
                    <div class="form-group">
                        ...
                        <select name="tipo_pessoa" id="tipo_pessoa"
                            ...
                            onchange="toggleDocumento(this.value)">
                    ...
                    <div class="form-group" id="campo_cnpj">
                        ...
                        <input type="text" name="cnpj" class="form-control @error('cnpj') is-invalid @enderror"
                            value="{{ old('cnpj', $fornecedor->cnpj ?? '') }}" maxlength="18"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="inscricao_estadual"
                            ...
                            value="{{ old('inscricao_estadual') }}" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="inscricao_municipal"
                            ...
                            value="{{ old('inscricao_municipal') }}" maxlength="255">
                ...
                <div class="form-grid form-grid--col-3" style="margin-top:1rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="telefone" class="form-control @error('telefone') is-invalid @enderror"
                            value="{{ old('telefone') }}" maxlength="20" placeholder="(00) 0000-0000">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="celular" class="form-control @error('celular') is-invalid @enderror"
                            value="{{ old('celular') }}" maxlength="20" placeholder="(00) 00000-0000">
                ...
                <div class="form-grid form-grid--col-4" style="margin-top:1rem;">
                    ...
                    <div class="form-group form-group--span-3">
                        ...
                        <textarea style="resize: none;" name="observacoes"
                            class="form-control @error('observacoes') is-invalid @enderror" rows="1"
        ...
        <script>
            function toggleDocumento(tipo) {
                ...
                if (tipo === 'PF') {
                    ...
                    cnpj.querySelector('input').value = '';
                } else {
                    cpf.style.display = 'none';
                    cnpj.style.display = 'flex';
                    cpf.querySelector('input').value = '';
                }
            }

            toggleDocumento(document.getElementById('tipo_pessoa').value);
        </script>
    @endpush
