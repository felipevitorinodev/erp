...
@section('breadcrumb')
    <a href="{{ route('fornecedor.index') }}">Fornecedores</a> / Editar Fornecedor
@endsection
...
<div class="card">
    <div class="card__header">
        <span class="card__title">Dados do Fornecedor</span>
    </div>
    ...
    <form method="POST" action="{{ route('fornecedor.update', $fornecedor) }}">
            ...
            <div class="form-grid form-grid--col-2">
                <div class="form-group">
                    ...
                    <input type="text" name="nome"
                        ...
                        value="{{ old('nome', $fornecedor->nome) }}" maxlength="255">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nome_fantasia"
                        ...
                        value="{{ old('nome_fantasia', $fornecedor->nome_fantasia) }}" maxlength="255">
            ...
            <div class="form-grid form-grid--col-4" style="margin-top:1rem;">
                <div class="form-group">
                    ...
                    <select name="tipo_pessoa" id="tipo_pessoa"
                        ...
                        <option value="PF" {{ old('tipo_pessoa', $fornecedor->cpf ? 'PF' : 'PJ') == 'PF' ? 'selected' : '' }}>Pessoa Física</option>
                        <option value="PJ" {{ old('tipo_pessoa', $fornecedor->cpf ? 'PF' : 'PJ') == 'PJ' ? 'selected' : '' }}>Pessoa Jurídica</option>
                    </select>
                ...
                <div class="form-group" id="campo_cpf">
                    ...
                    <input type="text" name="cpf"
                        ...
                        value="{{ old('cpf', $fornecedor->cpf ?? '') }}" maxlength="14" placeholder="000.000.000-00">
                ...
                <div class="form-group" id="campo_cnpj">
                    ...
                    <input type="text" name="cnpj"
                        ...
                        value="{{ old('cnpj', $fornecedor->cnpj ?? '') }}" maxlength="18" placeholder="00.000.000/0000-00">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="inscricao_estadual"
                        ...
                        value="{{ old('inscricao_estadual', $fornecedor->inscricao_estadual) }}" maxlength="255">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="inscricao_municipal"
                        ...
                        value="{{ old('inscricao_municipal', $fornecedor->inscricao_municipal) }}" maxlength="255">
            ...
            <div class="form-grid form-grid--col-3" style="margin-top:1rem;">
                <div class="form-group">
                    ...
                    <input type="text" name="telefone"
                        ...
                        value="{{ old('telefone', $fornecedor->telefone) }}" maxlength="20" placeholder="(00) 0000-0000">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="celular"
                        ...
                        value="{{ old('celular', $fornecedor->celular) }}" maxlength="20" placeholder="(00) 00000-0000">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email"
                        ...
                        value="{{ old('email', $fornecedor->email) }}" maxlength="255">
            ...
            <div class="form-grid form-grid--col-4" style="margin-top:1rem;">
                <div class="form-group">
                    ...
                    <input type="text" name="cep"
                        ...
                        value="{{ old('cep', $fornecedor->cep) }}" maxlength="9" placeholder="00000-000">
                ...
                <div class="form-group form-group--span-2">
                    ...
                    <input type="text" name="logradouro"
                        ...
                        value="{{ old('logradouro', $fornecedor->logradouro) }}" maxlength="255">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="numero"
                        ...
                        value="{{ old('numero', $fornecedor->numero) }}" maxlength="20">
            ...
            <div class="form-grid form-grid--col-4" style="margin-top:1rem;">
                <div class="form-group">
                    ...
                    <input type="text" name="bairro"
                        ...
                        value="{{ old('bairro', $fornecedor->bairro) }}" maxlength="255">
                ...
                <div class="form-group form-group--span-2">
                    ...
                    <input type="text" name="complemento"
                        ...
                        value="{{ old('complemento', $fornecedor->complemento) }}" maxlength="255">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cidade"
                        ...
                        value="{{ old('cidade', $fornecedor->cidade) }}" maxlength="255">
            ...
            <div class="form-grid form-grid--col-4" style="margin-top:1rem;">
                ...
                <div class="form-group form-group--span-3">
                    ...
                    <textarea style="resize:none;" name="observacoes"
                        ...
                        rows="1" maxlength="1000">{{ old('observacoes', $fornecedor->observacoes) }}</textarea>
        ...
        <div class="card__footer">
            <a href="{{ route('fornecedor.index') }}" class="btn btn--ghost">Cancelar</a>
