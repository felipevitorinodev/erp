...
@section('page_actions')
    <div class="page-actions">
        <a href="{{ route('relatorio.contas-receber.csv', request()->query()) }}" class="btn btn--ghost btn--sm">Exportar CSV</a>
...
@section('content')
    ...
    <div class="card mb-2">
        <div class="card__body">
            <form method="GET" action="{{ route('relatorio.contas-receber') }}" class="form-grid form-grid--col-3">
                ...
                <div class="form-group">
                    <div class="filter-actions">
                        ...
                        <a href="{{ route('relatorio.contas-receber') }}" class="btn btn--ghost btn--sm">Limpar</a>
                    </div>
                </div>
            </form>
        </div>
                    ...
                    <tbody>
                        @forelse($contas as $conta)
                            ...
                            <tr>
                                ...
                                <td data-label="Cliente">{{ $conta->cliente->nome ?? '—' }}</td>
