...
@section('page_title', 'Novo Funcionário')

@section('breadcrumb')
    <a href="{{ route('funcionario.index') }}">Funcionários</a> / Novo Funcionário
@endsection
                ...
                <div class="form-grid form-grid--col-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="usuario_id"
                            ...
                            value="{{ old('usuario_id') }}" maxlength="36"
                            placeholder="Deixe em branco se não tiver acesso ao sistema">
                        @error('usuario_id')<span class="form-error">{{ $message }}</span>@enderror
                    </div>
                </div>
                ...
                <div class="form-grid form-grid--col-4" style="margin-top:1rem;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="departamento"
                            ...
                            value="{{ old('departamento') }}" maxlength="100">
                    ...
                    <div class="form-group">
                        ...
                        @include('components.input-numeric', [
                            ...
                            'value' => old('percentual_comissao', '0'),
                ...
                <div class="form-grid" style="margin-top:1rem;">
                    <div class="form-group">
                        ...
                        <textarea style="resize: none;" name="observacoes"
                            class="form-control @error('observacoes') is-invalid @enderror" rows="3"
