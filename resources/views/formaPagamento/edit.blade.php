...
@section('page_title', 'Editar Forma de Pagamento')

@section('breadcrumb')
    <a href="{{ route('formaPagamento.index') }}">Formas de Pagamento</a> / Editar
@endsection
...
@section('content')
    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('formaPagamento.update', $formaPagamento) }}">
            @csrf
            @method('PUT')
                ...
                <div class="form-grid form-grid--col-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="nome" class="form-control @error('nome') is-invalid @enderror"
                            value="{{ old('nome', $formaPagamento->nome) }}" maxlength="100">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tipo" id="tipo-forma" class="form-control @error('tipo') is-invalid @enderror">
                            <option value="avista" {{ old('tipo', $formaPagamento->tipo) === 'avista' ? 'selected' : '' }}>À vista</option>
                            <option value="prazo" {{ old('tipo', $formaPagamento->tipo) === 'prazo' ? 'selected' : '' }}>A prazo</option>
                        </select>
                    ...
                    <div class="form-group" id="grupo-dias">
                        ...
                        @include('components.input-numeric', [
                            ...
                            'value' => old('dias_vencimento', $formaPagamento->dias_vencimento),
                    ...
                    <div class="form-group">
                        ...
                        <select name="ativo" class="form-control @error('ativo') is-invalid @enderror">
                            <option value="1" {{ old('ativo', $formaPagamento->ativo) ? 'selected' : '' }}>Sim</option>
                            <option value="0" {{ !old('ativo', $formaPagamento->ativo) ? 'selected' : '' }}>Não</option>
                        </select>
